...
export const PublicWebsite: React.FC<PublicWebsiteProps> = ({
  ...
  return (
    <div className="bg-[#FAF8F5] text-gray-800 font-sans antialiased selection:bg-amber-100 selection:text-amber-900">
      ...
      <header className="bg-white border-b border-gray-100 shadow-xs relative z-20 min-h-[66px] flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-1.5 flex items-center justify-between">
          {/* Logo */}
          <button
            type="button"
            onClick={() => navigateTo('home')}
            className="flex items-center gap-3 hover:opacity-95 transition-opacity py-0.5 cursor-pointer text-left shrink-0"
          >
            <QuranLogo
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-[11px] text-emerald-300/70 gap-3">
            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 text-center sm:text-left">
              <span>© 2021–2026 {settings.brandName || "Abdullah Quran Academy"}. All rights reserved.</span>
              <span className="hidden sm:inline text-emerald-600">•</span>
              <span className="text-amber-300/90 font-medium">
                Powered by <span className="text-amber-200 font-bold">Web Expert Agency</span>
              </span>
            </div>
